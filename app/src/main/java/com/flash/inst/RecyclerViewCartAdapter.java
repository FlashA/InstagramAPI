 ...
 */
public class RecyclerViewCartAdapter extends RecyclerView.Adapter<RecyclerViewCartAdapter.PersonViewHolder> {
    ...
    RecyclerViewCartAdapter(List<CardItem> cardItems){
